...
export const products: Record<string, ProductData> = {
  'drive-thru-timer': {
    ...
    heroMedia: { type: 'video', src: '/videos/drivethru_monitor.mp4' },
    howItWorks: [
      {
        step: '1',
      ...
      },
      {
        ...
        description:
          'View live dashboards showing current wait times, service speeds, and bottlenecks so your team can act immediately.',
      },
    ],
    sections: [
      {
  ...
  'lobby-timer': {
    ...
    description:
      'Track door-to-dine service times and monitor guest wait times to ensure exceptional in-restaurant experiences every time.',
    heroMedia: { type: 'video', src: '/videos/video_monitor.mp4' },
    howItWorks: [
      {
        step: '1',
        title: 'Set Up Cameras',
        description:
          'Cameras are positioned to cover your entrance, counter, and dining area. Installation takes hours, not days, with zero disruption to service.',
      },
      {
        step: '2',
        title: 'AI Detects Guests',
        description:
          'Hellometer\'s vision system identifies when guests enter, approach the counter, receive their order, and sit down — all without any manual input.',
      },
      {
        step: '3',
        title: 'Monitor Service Flow',
        description:
          'Live dashboards show your current guest count, average wait times, and service speed so managers can adjust staffing and processes on the fly.',
      },
    ],
    sections: [
      {
    ...
    benefits: [
      { metric: '25%', description: 'Shorter wait times' },
      { metric: '40%', description: 'More consistent service' },
      { metric: 'Real-time', description: 'Guest flow visibility' },
      { metric: 'All locations', description: 'Benchmarked together' },
    ],
    ctaText:
      'See how Lobby Timer can elevate your dining room service and guest satisfaction.',
  },
  ...
  'loss-prevention': {
    ...
    heroMedia: { type: 'video', src: '/videos/MONITOR_252.mp4' },
    howItWorks: [
      {
        step: '1',
        title: 'Deploy HD Cameras',
        description:
          'High-definition cameras are installed at critical points — registers, prep areas, storage rooms, and entrances — for complete coverage.',
      },
      {
        step: '2',
        title: 'AI Monitors Activity',
        description:
          'Intelligent analytics continuously watch for unusual patterns — register discrepancies, unauthorized access, and policy violations — without requiring constant human supervision.',
      },
      {
        step: '3',
        title: 'Get Instant Alerts',
        description:
          'When the system detects an anomaly, managers receive immediate notifications with video clips so they can review and respond quickly.',
      },
    ],
    sections: [
      {
    ...
    benefits: [
      { metric: '50%', description: 'Reduction in shrinkage' },
      { metric: '1080p', description: 'HD video clarity' },
      { metric: 'Instant', description: 'Alert notifications' },
  ...
  'kitchen-monitoring': {
    ...
    heroMedia: { type: 'video', src: '/videos/make_line_kitchen.mp4' },
    howItWorks: [
      {
        step: '1',
        title: 'Install Kitchen Cameras',
        description:
          'Cameras are positioned to cover prep stations, cooking lines, and plating areas. They are designed for kitchen environments — heat-resistant and easy to clean.',
      },
      {
        step: '2',
        title: 'AI Tracks Prep Workflow',
        description:
          'The system monitors food preparation steps, tracks ticket times from order to plate, and identifies when stations are backed up or idle.',
      },
      {
        step: '3',
        title: 'Ensure Compliance',
        description:
          'Automated monitoring helps verify that safety protocols are followed consistently — from food handling procedures to cleanliness standards.',
      },
    ],
    sections: [
      {
    ...
    benefits: [
      { metric: '99%', description: 'Compliance rate' },
      { metric: '20%', description: 'Waste reduction' },
      { metric: 'Real-time', description: 'Kitchen alerts' },
      { metric: 'Full', description: 'Kitchen visibility' },
    ],
    ctaText:
