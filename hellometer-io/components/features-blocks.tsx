 ...
 *
 * Displays the 4 main Hellometer products in a 2-column grid layout.
 * Each product includes:
 * - Icon (SVG with blue accent)
 * - Product name
 * - Brief description
 * - "Learn More" link to dedicated product page
 *
 * Layout: Single column on mobile, 2 columns on tablet+
 * Animations: Fade-up on scroll using AOS library
 */
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 font-playfair-display">Our Products</h2>
          ...
          <div className="relative max-w-sm mx-auto grid gap-16 md:grid-cols-2 lg:gap-y-20 items-start md:max-w-none" data-aos-id-blocks>
            ...
            <div className="relative" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h3 className="h4 font-playfair-display mb-2">Drive-Thru Timer</h3>
              <p className="text-lg text-slate-500 mb-3">Optimize drive-thru operations with real-time vehicle tracking and performance analytics. Reduce wait times and improve customer satisfaction.</p>
              <Link href="/products/drive-thru-timer" className="font-medium text-blue-600 hover:text-blue-700 inline-flex items-center transition duration-150 ease-in-out group">
            ...
            <div className="relative" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]" data-aos-delay="100">
              ...
              <h3 className="h4 font-playfair-display mb-2">Lobby Timer</h3>
              <p className="text-lg text-slate-500 mb-3">Track door-to-dine service times in your dining room. Monitor guest wait times and ensure exceptional in-restaurant experiences.</p>
              <Link href="/products/lobby-timer" className="font-medium text-blue-600 hover:text-blue-700 inline-flex items-center transition duration-150 ease-in-out group">
                Learn More <span className="tracking-normal group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1">→</span>
              </Link>
            </div>

            {/* 3rd item - Loss Prevention */}
            <div className="relative" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]" data-aos-delay="200">
              ...
              <h3 className="h4 font-playfair-display mb-2">Loss Prevention</h3>
              <p className="text-lg text-slate-500 mb-3">HD video monitoring with advanced analytics to protect your business. Identify issues quickly and reduce losses across all locations.</p>
              <Link href="/products/loss-prevention" className="font-medium text-blue-600 hover:text-blue-700 inline-flex items-center transition duration-150 ease-in-out group">
                Learn More <span className="tracking-normal group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1">→</span>
              </Link>
            </div>

            {/* 4th item - Kitchen Monitoring */}
            <div className="relative" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]" data-aos-delay="300">
              ...
              <h3 className="h4 font-playfair-display mb-2">Back of House / Kitchen Monitoring</h3>
              <p className="text-lg text-slate-500 mb-3">Real-time visibility into kitchen operations and food preparation. Ensure quality, safety, and efficiency standards are consistently met.</p>
              <Link href="/products/kitchen-monitoring" className="font-medium text-blue-600 hover:text-blue-700 inline-flex items-center transition duration-150 ease-in-out group">
                Learn More <span className="tracking-normal group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1">→</span>
              </Link>
            </div>
